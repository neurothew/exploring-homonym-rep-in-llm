...
do
    ...
    # ----- Different sense -----
    # echo "Running: computing Chinese lexical ambiguity -m $model -l zh"
    # python compute_lexical_ambiguity_sense-diff_lang-agnostic.py -m "$model" -l "zh"
    # echo "----------------------------------------"

    # ----- Same sense -----
    echo "Running: computing Chinese lexical ambiguity -m $model -l zh"
    python compute_lexical_ambiguity_sense-same_lang-agnostic.py -m "$model" -l "zh"
    echo "----------------------------------------"

    # ----- Compute English homonym baseline -----
    # ----- Different sense -----
    # echo "Running: computing English lexical ambiguity -m $model -l en"
    # python compute_lexical_ambiguity_sense-diff_lang-agnostic.py -m "$model" -l "en"
    # echo "----------------------------------------"

    # ----- Same sense -----
    # echo "Running: compute English lexical ambiguity -m $model -l en"
    # python compute_lexical_ambiguity_sense-same_lang-agnostic.py -m "$model" -l "en"
    # echo "----------------------------------------"
done